...
write_text_page = open("00_CA_Robotics.txt","w")
write_dQ_page = open("00_CA_Robotics_DQ.txt","w")
...
dQ5 = [1, 1000, ['4+', '5+', '6+', '7+', '8+', '9+', '10+', '5 years']]
